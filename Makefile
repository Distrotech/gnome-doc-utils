...
pkgincludedir = $(includedir)/gnome-doc-utils
pkglibdir = $(libdir)/gnome-doc-utils
pkglibexecdir = $(libexecdir)/gnome-doc-utils
...
CTAGS = ctags
CSCOPE = cscope
DIST_SUBDIRS = data po xslt tools xml2po doc
...
ACLOCAL = ${SHELL} /usr/src/gnome-doc-utils/gnome-doc-utils/missing aclocal-1.13
ALL_LINGUAS = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} /usr/src/gnome-doc-utils/gnome-doc-utils/missing autoconf
AUTOHEADER = ${SHELL} /usr/src/gnome-doc-utils/gnome-doc-utils/missing autoheader
AUTOMAKE = ${SHELL} /usr/src/gnome-doc-utils/gnome-doc-utils/missing automake-1.13
AWK = gawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
GNOME_DOC_UTILS_CFLAGS = -I/usr/include/libxml2  
GNOME_DOC_UTILS_LIBS = -lxslt -lz -ldl -lm -lxml2  
GREP = /usr/bin/grep
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /usr/src/gnome-doc-utils/gnome-doc-utils/missing makeinfo
...
abs_builddir = /usr/src/gnome-doc-utils/gnome-doc-utils
abs_srcdir = /usr/src/gnome-doc-utils/gnome-doc-utils
abs_top_builddir = /usr/src/gnome-doc-utils/gnome-doc-utils
abs_top_srcdir = /usr/src/gnome-doc-utils/gnome-doc-utils
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /usr/src/gnome-doc-utils/gnome-doc-utils/install-sh
